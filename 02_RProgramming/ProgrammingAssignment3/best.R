## Function returns the name of the hospital ranked "best" (lowest 30-day 
## mortality rate) in a state for one of the following outcomes: heart attack,
...
best <- function(state, outcome) {
    ...
    ordered[1,]$Hospital.Name    ## Return top rated hospital name
}